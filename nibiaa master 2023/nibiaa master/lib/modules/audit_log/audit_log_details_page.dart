...
class _AuditLogDetailsPageState extends TbContextState<AuditLogDetailsPage> {
  ...
  final valueTextStyle =
      TextStyle(color: Color.fromARGB(255, 217, 213, 213), fontSize: 13, height: 20 / 14);
        ...
        Container(
          ...
          child: SingleChildScrollView(
            child: Text(
              content,
              style: TextStyle(
                  color: Color.fromARGB(255, 255, 255, 255), fontSize: 14, height: 20 / 14),
            ),
          ),
        ),
        Positioned(
            ...
            child: Container(
              ...
              child: Text(
                title,
                style: TextStyle(
                    color: Color.fromARGB(255, 0, 0, 0), fontSize: 12, height: 14 / 12),
              ),
            )),
      ],
    );
